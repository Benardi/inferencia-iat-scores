...
Em média, as mulheres que participaram do experimento tiveram uma associação implícita (medida pelo IAT) com a matemática **negativa** e **média** (média 0.2854858, desv. padrão 0.5223609, N = 163). Homens tiveram uma associação **negativa** com a matemática, portanto **menor** que a das mulheres (média 0.2227761 , desv. padrão 0.5551954, N = 45). Houve portanto uma **pequena** diferença entre homens e mulheres (diferença das médias -0.06270964, 95% CI [-0.240690690969588, 0.121799518421087]). A partir desta amostra, estimamos que...
--- 
